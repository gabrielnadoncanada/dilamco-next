    ...
    <main id="contenu">
      <header>
        ...
        <p>
          ...
          fonctionnalité et exécution — principalement à Montréal, Laval et sur
          la Rive-Sud.
        </p>
        <p>
      ...
      <section aria-labelledby="role">
        ...
        <ul>
          <li>
            <strong>Optimiser l’espace :</strong> circulation, zones de travail,
            dégagements, hauteurs.
          </li>
          <li>
      ...
      <section aria-labelledby="inclus">
        ...
        <ul>
          <li>
            <strong>Analyse des besoins :</strong> vos priorités, votre usage et
            vos contraintes.
          </li>
          <li>
          ...
          <li>
            <strong>Choix matériaux & finis :</strong> décisions cohérentes avec
            l’usage (durabilité, entretien).
          </li>
          <li>
      ...
      <section aria-labelledby="usage">
        ...
        <ul>
          ...
          <li>
            <strong>Priorités claires :</strong> ce qui compte le plus pour vous
            (fonction, style, durabilité).
          </li>
        </ul>
      </section>
      ...
      <section aria-labelledby="contraintes">
        ...
        <ul>
          ...
          <li>
            <strong>Humidité :</strong> choix adaptés en salle de bain et salle
            de lavage.
          </li>
          <li>
      ...
      <section aria-labelledby="risque">
        ...
        <p>
          Plus les décisions sont prises tôt, plus le projet est prévisible. Un
          design solide réduit les imprévus, simplifie la fabrication et rend
          l’installation plus propre.
        </p>
        <ul>
          <li>
            <strong>Moins d’imprévus :</strong> contraintes identifiées avant la
            production.
          </li>
          <li>
      ...
      <section aria-labelledby="types">
        ...
        <ul>
          ...
          <li>
            <strong>Salle de bain :</strong> contraintes d’humidité, rangement,
            ergonomie.
            <br />
          ...
          <li>
            <strong>Salle de lavage :</strong> zones lavage/pliage, contraintes
      ...
      <section aria-labelledby="pas">
        ...
        <p>
          ...
          déconnectée de la réalité. Il vise un plan cohérent, faisable, et prêt
          pour la fabrication et l’installation.
        </p>
      </section>
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          ...
          <dd>
            Ça dépend du projet. Même lorsque l’idée est claire, il faut valider
            les contraintes, l’organisation et les dimensions pour assurer un
            résultat cohérent.
          </dd>
          ...
          <dd>
            Le design intervient au début, avant la fabrication, afin de valider
            la logique d’espace, les choix de matériaux et les contraintes
            techniques.
          </dd>
        </dl>
      </section>
