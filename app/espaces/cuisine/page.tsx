    ...
    <>
      ...
      <header>
        ...
        <p>
          ...
          usage quotidien : circulation, zones de travail, rangement, accès aux
      ...
      <section aria-labelledby="pour-qui">
        ...
        <p>
          ...
          mesure n’est probablement pas l’option la plus pertinente. L’objectif
          ici est la durabilité et la cohérence du résultat final.
        </p>
      </section>
      ...
      <section aria-labelledby="ce-qui-est-inclus">
        ...
        <ul>
          <li>
            <strong>Design & planification :</strong> besoins, ergonomie, plan,
            choix de matériaux.
          </li>
          <li>
            <strong>Fabrication sur mesure :</strong> armoires, modules, îlot et
            rangement adaptés.
          </li>
          <li>
      ...
      <section aria-labelledby="fonctionnalite">
        ...
        <ul>
          ...
          <li>
            <strong>Durabilité :</strong> choix adaptés aux cycles d’ouverture,
            aux charges et à l’entretien.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="materiaux">
        ...
        <p>
          Le rendu haut de gamme est une somme de décisions : structure, chants,
          quincaillerie, assemblage et installation. Le bon matériau dépend de
          l’usage et des contraintes du projet.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Portes & finis :</strong> MDF, bois massif, finis adaptés au
            style et à l’entretien.
          </li>
          <li>
      ...
      <section aria-labelledby="local">
        ...
        <p>
          Nos cuisines sur mesure sont réalisées principalement à Montréal,
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          ...
          <dt>Qu’est-ce qui influence le plus la durabilité d’une cuisine?</dt>
          <dd>
            La durabilité dépend du matériau, mais aussi de l’assemblage, des
            chants, de la quincaillerie et de l’installation. L’usage (charges,
            humidité, entretien) compte autant que le look.
          </dd>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          ...
          vos besoins (îlot, rangement, style, contraintes). On vous propose la
