    ...
    <main id="contenu">
      ...
      <section aria-labelledby="pour-qui">
        ...
        <p>
          ...
          est moins pertinent. Le sur mesure est surtout utile quand l’espace
          est technique, atypique ou lorsqu’on veut un rangement réellement
          fonctionnel.
        </p>
      </section>
      ...
      <section aria-labelledby="fonctionnalite">
        ...
        <ul>
          ...
          <li>
            <strong>Paniers & linge :</strong> organisation logique pour éviter
            que tout s’accumule.
          </li>
        </ul>
      </section>
      ...
      <section aria-labelledby="technique">
        ...
        <p>
          ...
          chants exposés à l’eau, surfaces difficiles à nettoyer, quincaillerie
          qui fatigue. Notre approche vise la durabilité dans le temps.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Usage répété :</strong> quincaillerie fiable pour ouvertures
            fréquentes (tiroirs/portes).
          </li>
          <li>
      ...
      <section aria-labelledby="configurations">
        ...
        <ul>
          ...
          <li>
            <strong>Buanderie dans un placard :</strong> modules adaptés, accès
            simple, gestion des portes et dégagements.
          </li>
          <li>
            <strong>Évier utilitaire (si applicable) :</strong> rangement adapté
            aux produits et à l’espace humide.
          </li>
          <li>
          ...
          <li>
            <strong>Armoires hautes + colonne :</strong> maximiser le rangement
            pour linge, paniers et accessoires.
          </li>
        </ul>
      </section>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          ...
          paniers, produits). On vous propose la prochaine étape la plus simple
          pour avancer.
        </p>
        <p>
          <a href="/contact/">Demander une soumission</a>
