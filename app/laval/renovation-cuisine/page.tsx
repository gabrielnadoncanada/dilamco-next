...
export const metadata: Metadata = {
  ...
  description:
    "Rénovation de cuisine à Laval : planification, coordination des travaux, installation et finition. Option clé en main avec un seul responsable selon le projet.",
  alternates: {
...
export default function LavalRenovationCuisine() {
  return (
    <>
      <JsonLd
        data={serviceJsonLd({
          name: "Rénovation de cuisine à Laval",
          description:
            "Planification, coordination des travaux, installation et finition pour rénovations de cuisine à Laval, avec option clé en main selon le projet.",
          url: SITE.url + "/laval/renovation-cuisine/",
      ...
      <main id="contenu">
        <header>
          <h1>Rénovation de cuisine à Laval</h1>
          <p>
            ...
            cohérent. À Laval, Dilamco peut prendre en charge la rénovation de
            cuisine avec une approche structurée — incluant la conception,
            l’installation d’armoires sur mesure et, lorsque requis, une option
            clé en main avec un seul responsable.
          </p>
        </header>
        ...
        <section aria-labelledby="cta">
          ...
          <p>
            Dites-nous votre secteur à Laval, ce que vous voulez changer
