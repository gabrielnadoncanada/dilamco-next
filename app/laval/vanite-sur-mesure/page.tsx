...
export const metadata: Metadata = {
  ...
  description:
    "Vanité sur mesure à Laval : design, fabrication et installation haut de gamme. Solutions durables adaptées à l’humidité, avec option rénovation de salle de bain selon le projet.",
  alternates: {
    canonical: "https://dilamco.com/laval/vanite-sur-mesure/",
  },
};

export default function LavalVaniteSurMesure() {
  return (
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          description:
            "Design, fabrication et installation de vanités sur mesure à Laval, avec option rénovation de salle de bain selon le projet.",
      ...
      <main id="contenu">
        <header>
          <h1>Vanité sur mesure à Laval</h1>
          <p>
            Dilamco conçoit et réalise des vanités sur mesure haut de gamme à
            Laval. L’objectif : une vanité durable, bien pensée pour le
        ...
        <section aria-labelledby="cta">
          ...
          <p>
            Dites-nous votre secteur à Laval, la largeur disponible, si vous
