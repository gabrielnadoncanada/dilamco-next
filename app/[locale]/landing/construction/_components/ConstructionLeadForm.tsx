...
import {
  submitConstructionLead,
  type ConstructionLeadState,
} from "../actions";
...
export function ConstructionLeadForm() {
  ...
  return (
    <form action={formAction} className="grid gap-4 md:grid-cols-2">
      ...
      <div>
        <FloatSelect
          id="construction-type-projet"
          name="type_projet"
          label="Type de projet"
          options={typeProjetOptions}
          placeholder="Sélectionnez votre projet"
          required
          invalid={Boolean(err.type_projet)}
        />
        <FieldError error={err.type_projet} />
      </div>
