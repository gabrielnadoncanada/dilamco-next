...
export const metadata: Metadata = {
  title: "Vanité sur mesure sur la Rive-Sud | Dilamco",
  description:
    "Vanité sur mesure sur la Rive-Sud : design, fabrication et installation haut de gamme. Solutions durables adaptées à l’humidité, avec option rénovation de salle de bain selon le projet.",
  alternates: {
    canonical: "https://dilamco.com/rive-sud/vanite-sur-mesure/",
  },
};

export default function RiveSudVaniteSurMesure() {
  return (
    <>
      <JsonLd
        data={serviceJsonLd({
          name: "Vanité sur mesure sur la Rive-Sud",
          description:
            "Design, fabrication et installation de vanités sur mesure sur la Rive-Sud, avec option rénovation de salle de bain selon le projet.",
      ...
      <main id="contenu">
        <header>
          <h1>Vanité sur mesure sur la Rive-Sud</h1>
          <p>
            Dilamco conçoit et réalise des vanités sur mesure haut de gamme sur
            la Rive-Sud. L’objectif : une vanité durable, bien pensée pour le
        ...
        <section aria-labelledby="cta">
          ...
          <p>
            Dites-nous votre ville sur la Rive-Sud, la largeur disponible, si
            vous souhaitez un simple remplacement ou une rénovation, et votre
