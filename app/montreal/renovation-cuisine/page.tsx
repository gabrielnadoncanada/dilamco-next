...
export const metadata: Metadata = {
  ...
  description:
    "Rénovation de cuisine à Montréal : planification, coordination des travaux, installation et finition. Option clé en main avec un seul responsable selon le projet.",
  alternates: {
    ...
    <>
      <JsonLd
        data={serviceJsonLd({
          ...
          description:
            "Planification, coordination des travaux, installation et finition pour rénovations de cuisine à Montréal, avec option clé en main selon le projet.",
      ...
      <main id="contenu">
        <header>
          <h1>Rénovation de cuisine à Montréal</h1>
          <p>
            ...
            cohérent. À Montréal, Dilamco peut prendre en charge la rénovation
            de cuisine avec une approche structurée — incluant la conception,
        ...
        <section aria-labelledby="cta">
          ...
          <p>
            Dites-nous votre secteur à Montréal, ce que vous voulez changer
