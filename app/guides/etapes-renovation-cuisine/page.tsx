...
export default function EtapesRenovationCuisine() {
  return (
    <main id="contenu">
      <header>
        <h1>Les étapes d’une rénovation de cuisine — du plan à la finition</h1>
        <p>
          ...
          difficile. Ce guide présente le déroulement typique d’un projet, de la
          planification à l’inspection finale, pour vous aider à cadrer votre
          décision avant de lancer le chantier.
        </p>
        <p>
      ...
      <section aria-labelledby="overview">
        ...
        <ol>
          ...
          <li>Choix des matériaux et finis (usage, entretien, durabilité).</li>
          <li>Préparation du chantier (logistique, démolition, protection).</li>
          <li>
      ...
      <section aria-labelledby="cadrage">
        ...
        <p>
          Avant de parler matériaux ou style, clarifiez le cadre : qu’est-ce qui
          doit changer et pourquoi? Une rénovation peut aller d’un remplacement
          d’armoires à un projet complet avec travaux connexes.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Portée :</strong> armoires seulement vs rénovation complète
            (plomberie/électricité/plancher).
          </li>
          <li>
      ...
      <section aria-labelledby="design">
        ...
        <ul>
          <li>Plan et ergonomie (circulation, dégagements, îlot réaliste).</li>
          <li>
      ...
      <section aria-labelledby="preparation">
        ...
        <ul>
          ...
          <li>Accès chantier : stationnement, ascenseur, horaires, voisins.</li>
      ...
      <section aria-labelledby="travaux">
        ...
        <ul>
          <li>
            <strong>Plomberie :</strong> évier, lave-vaisselle, relocalisations
            si nécessaires.
          </li>
          <li>
            <strong>Électricité :</strong> circuits, prises, éclairage, hotte et
            électroménagers.
          </li>
          <li>
      ...
      <section aria-labelledby="fabrication">
        ...
        <p>
          Une fois le plan validé, la fabrication suit le projet. L’installation
          exige précision et ajustements : niveaux, alignements, jeux réguliers
          et finition propre.
        </p>
        <ul>
      ...
      <section aria-labelledby="inspection">
        ...
        <p>
          ...
          détail. C’est aussi le moment de confirmer les dernières retouches si
          nécessaires.
        </p>
        <ul>
      ...
      <section aria-labelledby="delais">
        ...
        <p>
          Les délais varient selon la complexité, la disponibilité et la portée
          des travaux. Ce qui allonge le plus un projet : changements tardifs,
          décisions non finalisées, et séquencement mal coordonné entre
          intervenants.
        </p>
        <ul>
      ...
      <section aria-labelledby="erreurs">
        ...
        <ul>
          <li>Commander ou fabriquer avant que le plan soit vraiment final.</li>
          <li>
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          <dt>Peut-on sauter certaines étapes?</dt>
          <dd>
            On peut adapter la portée, mais l’ordre logique reste le même. Ce
            qui est risqué, c’est de démarrer sans plan validé ou de faire les
            travaux techniques trop tard.
          </dd>

          <dt>Faut-il tout décider avant de démarrer?</dt>
          <dd>
            Les décisions structurantes oui : plan, électroménagers, contraintes
            techniques, matériaux et séquence des travaux. Ça réduit fortement
            les reprises et les délais.
          </dd>

          <dt>Quand “commander” ou lancer la fabrication?</dt>
          <dd>
            Lorsque le plan est final, les contraintes techniques validées, et
            les choix essentiels confirmés. Les changements tardifs coûtent
            cher.
          </dd>

          <dt>Clé en main ou coordination personnelle?</dt>
          <dd>
            Si plusieurs corps de métier sont impliqués, le clé en main
            simplifie la coordination et réduit les zones grises. Sinon, vous
            devrez gérer l’ordre des étapes et les responsabilités.
          </dd>
        </dl>
      </section>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          ...
          l’ampleur des travaux (armoires seulement ou rénovation complète). On
          vous propose la prochaine étape la plus simple pour avancer.
        </p>
        <p>
      ...
      <section aria-labelledby="liens">
        ...
        <ul>
          ...
          <li>
            <a href="/guides/erreurs-renovation-cuisine/">Erreurs fréquentes</a>
          </li>
          <li>
            <a href="/contact/">Demander une soumission</a>
          </li>
