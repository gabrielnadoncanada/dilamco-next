    ...
    <main id="contenu">
      <header>
        ...
        <p>
          ...
          intervenants : plan, matériaux, plomberie, électricité, installation,
          finitions. Beaucoup d’erreurs coûtent cher non seulement en argent,
          mais aussi en délais et en stress. Ce guide vous aide à repérer les
          pièges les plus courants et à les éviter avant le chantier.
        </p>
        <p>
      ...
      <section aria-labelledby="planification">
        ...
        <p>
          ...
          décisions prises “pendant” le chantier. Une modification tardive peut
          déclencher des effets en chaîne (plomberie, électricité, gypse,
      ...
      <section aria-labelledby="materiaux">
        <h2 id="materiaux">2) Choisir les matériaux pour le look seulement</h2>
        <p>
          Un matériau peut être beau et pourtant mal adapté à l’usage (humidité,
          impacts, entretien). Le point critique est souvent la protection des
          chants et la cohérence du système (matériau + quincaillerie +
          installation).
        </p>
        <ul>
      ...
      <section aria-labelledby="installation">
        ...
        <p>
          ...
          l’installation est approximative : alignements, niveaux, ajustements,
          finitions et inspection finale.
        </p>
        <ul>
      ...
      <section aria-labelledby="quincaillerie">
        ...
        <p>
          La quincaillerie influence le confort et la longévité : charnières qui
          gardent leurs réglages, coulisses stables en charge, fermeture
          contrôlée.
        </p>
        <ul>
      ...
      <section aria-labelledby="echeancier">
        ...
        <p>
          Les délais s’allongent quand les dépendances entre étapes ne sont pas
          respectées (démolition, plomberie/électricité, murs, plancher,
          peinture, comptoir, installation, finitions). Prévoir une marge réduit
          le stress et les décisions précipitées.
        </p>
        <ul>
          <li>Planifier l’ordre des étapes (et les temps de séchage).</li>
          <li>Confirmer la disponibilité des matériaux et des intervenants.</li>
      ...
      <section aria-labelledby="prix">
        ...
        <p>
          ...
          coordination, ajustements et finition; l’autre non. Les “coûts cachés”
          (reprises, délais, gestion) apparaissent souvent après coup.
        </p>
        <ul>
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          <dt>Quelle est l’erreur la plus coûteuse?</dt>
          <dd>
            Les changements tardifs. Une modification en cours de chantier peut
            forcer des reprises (plomberie, électricité, murs, comptoir) et
            créer des délais.
          </dd>

          <dt>Faut-il tout décider avant de démarrer?</dt>
          <dd>
            Les décisions structurantes oui : plan, contraintes techniques,
            électroménagers, matériaux et séquence des travaux. Plus vous
            décidez en amont, moins vous payez en stress et en reprises.
          </dd>

          <dt>Clé en main ou coordination personnelle?</dt>
          <dd>
            Si plusieurs corps de métier sont impliqués et que vous voulez
            réduire les imprévus, une approche clé en main peut être plus
            simple. Sinon, vous devrez gérer la coordination et les zones
            grises.
          </dd>

          <dt>Pourquoi l’installation est-elle aussi importante?</dt>
          <dd>
            Parce qu’elle conditionne les alignements, les ajustements et la
            finition. C’est souvent ce qui fait la différence entre “correct” et
            “haut de gamme”.
          </dd>
        </dl>
      </section>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          ...
          échéance et l’ampleur des travaux. On vous propose la prochaine étape
          la plus simple pour avancer.
        </p>
        <p>
