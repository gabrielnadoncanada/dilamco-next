  ...
  return (
    <main id="contenu">
      ...
      <section aria-labelledby="methodologie">
        ...
        <p>
          La performance finale ne dépend pas seulement du matériau, mais aussi
          de l’assemblage, des chants, de la quincaillerie et de l’installation.
          Voici les critères qui guident nos recommandations.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Stabilité :</strong> limiter les déformations dans le temps
      ...
      <section aria-labelledby="pages-materiaux">
        ...
        <ul>
          ...
          <li>
            ...
            <p>
              Option économique avec finis variés. Attention aux impacts et aux
              chants en milieu humide.
            </p>
          </li>
          ...
          <li>
            ...
            <p>
              Charnières et coulisses = confort + durabilité. L’installation est
              aussi déterminante.
            </p>
          </li>
      ...
      <section aria-labelledby="comparatif">
        ...
        <p>
          <small>
            Note : ces catégories sont indicatives. La performance dépend aussi
            de la qualité d’assemblage, des chants, de la quincaillerie et de
            l’installation.
          </small>
        </p>
      </section>
      ...
      <section aria-labelledby="par-espace">
        ...
        <ul>
          ...
          <li>
            <strong>Salle de bain :</strong> humidité, ventilation, matériaux et
      ...
      <section aria-labelledby="premium">
        ...
        <p>
          ...
          précise. Le choix des matériaux est important, mais l’exécution l’est
          tout autant.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Finition & installation :</strong> alignements, ajustements,
            inspection finale.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          ...
          <dd>
            Elle peut être pertinente selon le contexte et le budget, mais elle
            est plus sensible aux impacts et à l’humidité si les chants sont
            endommagés.
          </dd>
          ...
          <dd>
            ...
            moins de stress sur les composants, meilleure perception de qualité.
          </dd>
