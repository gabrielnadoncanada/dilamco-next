    ...
    <>
      ...
      <header>
        ...
        <p>
          ...
          il réagit à l’humidité et à la température. Pour un résultat durable,
          l’important n’est pas seulement “bois massif ou non”, mais{" "}
          <strong>où</strong> et <strong>comment</strong> il est utilisé dans un
          projet sur mesure.
        </p>
        <p>
      ...
      <section aria-labelledby="definition">
        ...
        <p>
          ...
          (MDF, mélamine, contreplaqué) et des solutions comme le placage (fine
          couche de bois sur un support).
        </p>
        <p>
          Visuellement, il présente des variations naturelles : veinage, nœuds,
          teinte et texture. Ces variations font partie du charme du matériau.
        </p>
      </section>
      ...
      <section aria-labelledby="avantages">
        ...
        <ul>
          ...
          <li>
            <strong>Valeur perçue :</strong> matériau reconnu et recherché pour
      ...
      <section aria-labelledby="limites">
        ...
        <p>
          Le bois massif peut être excellent, mais il demande une conception et
          une exécution appropriées. Ignorer ses contraintes mène souvent à des
          attentes irréalistes.
        </p>
        <ul>
          <li>
            <strong>Mouvement :</strong> le bois peut bouger avec l’humidité et
            la température (expansion/contraction).
          </li>
          <li>
      ...
      <section aria-labelledby="ou-pertinent">
        ...
        <ul>
          ...
          <li>
            <strong>Pièces sélectionnées :</strong> là où le matériau apporte un
            vrai gain esthétique.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="ou-deconseille">
        ...
        <ul>
          ...
          <li>
            <strong>Grandes surfaces :</strong> plus le panneau est grand, plus
            le mouvement peut devenir visible.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="comparaisons">
        ...
        <p>
          Le bon choix dépend de l’espace (cuisine, salle de bain, walk-in), du
          niveau d’entretien attendu et du rendu souhaité.
        </p>
        <ul>
          <li>
            <strong>Bois massif vs MDF :</strong> souvent choisi pour la texture
            et le grain; le MDF peut être pertinent selon le fini.
          </li>
          <li>
            <strong>Bois massif vs mélamine :</strong> la mélamine vise surtout
            praticité et entretien; le bois vise caractère.
          </li>
          <li>
      ...
      <section aria-labelledby="finition">
        ...
        <ul>
          <li>
            <strong>Protection :</strong> plus la protection est élevée, plus le
            matériau résiste à l’usage.
          </li>
          <li>
      ...
      <section aria-labelledby="projets">
        ...
        <p>
          Le bois massif est souvent utilisé sur des éléments visibles (portes,
          façades, accents) pour un rendu chaleureux. Consultez nos réalisations
          pour voir des exemples de finitions et de styles.
        </p>
        <p>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          ...
          secteur (Montréal/Laval/Rive-Sud) et le rendu recherché. On vous aide
          à choisir une combinaison durable et cohérente.
        </p>
        <p>
