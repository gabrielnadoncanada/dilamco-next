  ...
  return (
    <>
      ...
      <header>
        ...
        <p>
          Le contreplaqué est un matériau “technique” souvent privilégié en sur
          mesure pour la structure des armoires. Son avantage principal vient de
          sa composition en plis croisés : un comportement plus stable et plus
          prévisible, utile dans des environnements réels (variations
          d’humidité, usage intensif, contraintes de chantier).
        </p>
        <p>
      ...
      <section aria-labelledby="definition">
        ...
        <p>
          ...
          <a href="/materiaux/melamine/">mélamine</a> (panneau + revêtement) et
          du <a href="/materiaux/bois-massif/">bois massif</a> (pièce pleine).
        </p>
      </section>
      ...
      <section aria-labelledby="avantages">
        ...
        <ul>
          ...
          <li>
            <strong>Tenue des vis :</strong> bonne résistance au vissage et aux
            fixations, utile pour les caissons et l’installation.
          </li>
          <li>
      ...
      <section aria-labelledby="comparaison">
        ...
        <ul>
          ...
          <li>
            <strong>Contreplaqué vs mélamine :</strong> la mélamine vise surtout
            praticité/coût; le contreplaqué vise structure/durabilité.
          </li>
          <li>
      ...
      <section aria-labelledby="usages">
        ...
        <p>
          Le contreplaqué est souvent utilisé là où la stabilité et la solidité
          comptent le plus : structures, caissons et composantes internes.
        </p>
        <ul>
          <li>
          ...
          <li>
            <strong>Projets à contraintes :</strong> lorsque la durabilité et la
            tenue dans le temps sont prioritaires.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="limites">
        ...
        <ul>
          <li>
            <strong>Qualité variable :</strong> le grade influence la stabilité,
            l’apparence et la durabilité.
          </li>
          <li>
            <strong>Coût :</strong> souvent plus élevé que des options standard.
          </li>
          <li>
            <strong>Tranches visibles :</strong> si exposées, elles doivent être
            traitées ou intégrées au design.
          </li>
          <li>
      ...
      <section aria-labelledby="pourquoi-dilamco">
        ...
        <p>
          ...
          cohérent, avec des alignements plus prévisibles et une meilleure tenue
          dans le temps.
        </p>
        <ul>
          <li>
      ...
      <section aria-labelledby="projets">
        ...
        <p>
          Consultez nos réalisations pour voir des projets où la structure et la
          fabrication ont été pensées pour durer, selon l’espace et l’usage.
        </p>
        <p>
      ...
      <section aria-labelledby="cta">
        ...
        <p>
          Dites-nous votre espace (cuisine, salle de bain, walk-in, commercial),
          votre secteur (Montréal/Laval/Rive-Sud) et vos priorités (durabilité,
          entretien, finition). On vous aide à choisir une combinaison
          cohérente.
        </p>
        <p>
          <a href="/contact/">Demander une soumission</a> {" | "}
