    ...
    <main id="contenu">
      <header>
        ...
        <p>
          ...
          facteur le plus déterminant de l’expérience au quotidien. Ce sont les
          pièces qui bougent, donc celles qui s’usent. Une quincaillerie de
          qualité, bien installée et bien ajustée, améliore la longévité, la
          stabilité et le “feel” haut de gamme.
        </p>
        <p>
      ...
      <section aria-labelledby="pourquoi">
        ...
        <ul>
          ...
          <li>
            <strong>Perception de qualité :</strong> une cuisine peut “sembler”
            haut de gamme ou standard selon la fluidité des tiroirs et des
            portes.
          </li>
        </ul>
      </section>
      ...
      <section aria-labelledby="cuisine-sdb">
        ...
        <ul>
          <li>
            Humidité : importance des détails d’exécution et de la cohérence des
            choix.
          </li>
          <li>
      ...
      <section aria-labelledby="choix">
        ...
        <ul>
          ...
          <li>
            <strong>Contexte :</strong> humidité (salle de bain), environnement,
            contraintes.
          </li>
          <li>
          ...
          <li>
            <strong>Installation :</strong> une pose et des ajustements soignés
            sont essentiels.
          </li>
        </ul>
        <p>
      ...
      <section aria-labelledby="faq">
        ...
        <dl>
          <dt>Le soft-close est-il vraiment utile?</dt>
          <dd>
            Oui si le système est fiable et bien installé : fermeture plus
            douce, moins de chocs, et meilleure expérience au quotidien.
          </dd>

          <dt>Est-ce que la quincaillerie influence la durée de vie?</dt>
          <dd>
            Oui. Ce sont les pièces qui bougent et qui s’usent. Une
            quincaillerie de qualité garde ses réglages, supporte mieux les
            charges, et vieillit mieux.
          </dd>

          <dt>Peut-on remplacer la quincaillerie plus tard?</dt>
          <dd>
            Parfois, mais ce n’est pas toujours simple. Il vaut mieux choisir un
            système cohérent dès le départ, surtout pour les tiroirs et les
            charges élevées.
          </dd>

          <dt>Pourquoi l’installation est-elle aussi importante?</dt>
          <dd>
            Parce que la précision (alignements, ajustements, fixations) affecte
            directement le fonctionnement. Une bonne quincaillerie mal installée
