...
import type { MenuItem, LogoConfig } from "@/components/navbar/navbar.types";

// Brand configuration
export const BRAND: LogoConfig & { tagline: string } = {
...
// Main navigation (used by navbar)
...
// Legal/bottom links
export const LEGAL_LINKS: { text: string; url: string }[] = [
  {
