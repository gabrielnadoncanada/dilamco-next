...
function NavigationMenuLink({
  ...
  return (
    <NavigationMenuPrimitive.Link
      ...
      className={cn("data-active:focus:bg-secondary data-active:hover:bg-secondary data-active:bg-secondary focus-visible:ring-ring/50 hover:bg-secondary focus:bg-secondary flex items-center gap-2 rounded-lg p-2 text-sm leading-6 transition-all outline-none focus-visible:ring-3 focus-visible:outline-1 in-data-[slot=navigation-menu-content]:rounded-md [&_svg:not([class*='size-'])]:size-4", className)}
      {...props}
    />
  )
}
