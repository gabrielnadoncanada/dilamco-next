    ...
    groups: [
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Bath,
            description: "Waterproofing, ventilation, plumbing and tile.",
          },
          {
          ...
          },
          {
            ...
            icon: Building2,
            description: "Permit, foundation, structure, walls and roof.",
          },
          {
            label: "Flooring renovation",
            url: "/services/renovation/plancher/",
            icon: Layers,
            description: "Hardwood, vinyl or tile on a levelled subfloor.",
          },
          {
    ...
    groups: [
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Bath,
            description: "Custom vanities, installed with the plumbing.",
          },
          {
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Settings2,
            description: "Your cabinets built by our partner factory.",
          },
          {
            label: "Installation",
            url: "/services/installation/",
            icon: Wrench,
            description: "Install, door adjustment and touch-ups at hand-over.",
          },
          {
            label: "Materials",
            url: "/materiaux/",
