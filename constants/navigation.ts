    ...
    groups: [
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Bath,
            description: "Étanchéité, ventilation, plomberie et céramique.",
          },
          {
          ...
          },
          {
            ...
            icon: Building2,
            description: "Permis, fondation, structure, murs et toit.",
          },
          {
            label: "Rénovation de plancher",
            url: "/services/renovation/plancher/",
            icon: Layers,
            description: "Bois franc, vinyle ou céramique, support mis à niveau.",
          },
          {
    ...
    groups: [
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Bath,
            description: "Vanités sur mesure, posées avec la plomberie.",
          },
          {
      ...
      },
      {
        ...
        links: [
          ...
          },
          {
            ...
            icon: Settings2,
            description: "Vos armoires produites par notre usine partenaire.",
          },
          {
            label: "Installation",
            url: "/services/installation/",
            icon: Wrench,
            description: "Pose, ajustement des portes et retouches à la livraison.",
          },
          {
            label: "Matériaux",
            url: "/materiaux/",
