    ...
    <SpacePageTemplate
      data={{
        ...
        service: {
          ...
          description:
            "Vanités et rangement de salle de bain sur mesure conçus pour l'humidité : design, fabrication et installation, avec option de rénovation clé en main.",
          url: SITE.url + "/espaces/salle-de-bain/",
        ...
        includedLinks: {
          ...
          links: [
            ...
            },
            {
              ...
              description:
                "Vanité, rangement, modules adaptés (simple ou double).",
            },
            {
