    ...
    <SpacePageTemplate
      data={{
          ...
          description: (
            <>
              <p>
                ...
                aux coins, et finition. Dilamco réalise des cuisines sur mesure
                haut de gamme avec option de rénovation clé en main selon le
                projet - principalement à Montréal, Laval et sur la Rive-Sud.
              </p>
            </>
          ),
          image: {
        ...
        projectLinks: {
          ...
          links: [
            {
              label: "Voir tous les projets de cuisines",
              href: "/projets/cuisine/",
            },
