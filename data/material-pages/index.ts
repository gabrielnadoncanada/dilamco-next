...
import { metadata as couleursMetadata, pageData as couleursPageData } from "@/data/material-pages/couleurs";
import { metadata as mdfMetadata, pageData as mdfPageData } from "@/data/material-pages/mdf";
...
export const MATERIAL_PAGES: Record<MaterialSlug, MaterialPageDefinition> = {
  ...
  contreplaque: { metadata: contreplaqueMetadata, pageData: contreplaquePageData },
  ...
  quincaillerie: { metadata: quincaillerieMetadata, pageData: quincailleriePageData },
};

export const MATERIAL_PAGE_SLUGS = Object.keys(MATERIAL_PAGES) as MaterialSlug[];
