...
export const metadata: Metadata = createPageMetadata({
    title: "Comparatifs",
    description: "Comparatifs pour aider à choisir : sur mesure vs IKEA, sur mesure vs Home Depot, cuisiniste vs entrepreneur général.",
    path: "/comparatifs/",
...
export const pageData: ArticlePageData = {
    ...
    hero: {
        ...
        description: "Ces comparatifs vous aident à décider avec des critères concrets : matériaux, exécution, coordination et coûts cachés.",
        actions: [
