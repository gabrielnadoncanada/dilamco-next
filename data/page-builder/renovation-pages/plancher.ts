    ...
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          intro:
            "Reponses claires sur sequence, condo et integration au reste du chantier.",
          items: [
            {
    ...
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          intro:
            "On vous aide a cadrer la bonne sequence et les bons raccords pour proteger le resultat final.",
          actions: [
            {
              label: "Demander une soumission",
              href: "/contact/",
