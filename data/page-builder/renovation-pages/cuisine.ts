    ...
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          intro:
            "La portee exacte est confirmee lors de la soumission, mais la sequence reste claire.",
          steps: [
            {
              number: "1",
              title: "Design",
              description:
                "Organisation de l'espace, ergonomie et decisions cles.",
            },
            {
              number: "2",
              title: "Fabrication",
              description: "Armoires, ilot et rangement sur mesure.",
            },
            {
              number: "3",
              title: "Installation",
              description: "Alignements, ajustements et finition soignee.",
            },
            {
              number: "4",
              title: "Coordination",
              description: "Travaux connexes sequences proprement au besoin.",
            },
          ],
        },
      },
    ...
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          intro:
            "On vous aide a definir la bonne sequence et le bon niveau de coordination.",
          actions: [
            {
              label: "Demander une soumission",
              href: "/contact/",
