...
export const agrandissementMaisonPage: PageTemplateData = {
  ...
  breadcrumbs: [
    ...
    { name: "Agrandissement de maison", url: SITE.url + "/services/renovation/agrandissement-de-maison/" },
  ],
  service: {
  ...
  blocks: [
    {
      ...
      content: {
        ...
        props: {
          ...
          heading: "Agrandissement de maison, planification, coordination et execution complete",
          description:
          ...
          image: { src: "/images/spaces/commercial.webp", alt: "Agrandissement de maison" },
    ...
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          items: [
            { q: "Est-ce que Dilamco gere des agrandissements complets?", a: "Oui, selon la portee definie, avec planification, coordination et execution complete." },
            { q: "Quels types d'agrandissement sont possibles?", a: "La faisabilite depend de la maison existante, du terrain et des reglements applicables." },
            { q: "Est-ce un projet cle en main?", a: "Oui lorsque le projet le requiert. Le niveau de coordination est defini clairement a la soumission." },
            { q: "Combien de temps dure un agrandissement?", a: "La duree varie selon la complexite, la superficie et les contraintes. Un echeancier est etabli apres analyse." },
          ],
        },
      },
    },
    {
      ...
      content: {
        ...
        props: {
          ...
          intro: "On vous aide a cadrer la faisabilite, la sequence et la coordination pour un projet integre a l'existant.",
          actions: [
            { label: "Demander une soumission", href: "/contact/", variant: "default" },
            { label: "Voir la renovation cle en main", href: "/services/renovation/", variant: "outline" },
          ],
