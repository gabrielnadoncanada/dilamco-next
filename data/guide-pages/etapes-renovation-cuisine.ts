...
export const pageData: ArticlePageData = {
  ...
  sections: [
    {
      id: "overview",
      title: "Vue d'ensemble (le bon ordre des étapes)",
      content: {
    ...
    {
      id: "materiaux",
      title: "3) Choix des matériaux et finis",
      content: {
        type: SECTION_TYPES.TEXT,
        paragraphs: [
    ...
    {
      id: "preparation",
      title: "4) Préparation du chantier",
      content: {
        type: SECTION_TYPES.TEXT,
        paragraphs: [
    ...
    {
      id: "travaux",
      title: "5) Travaux techniques (avant l'installation)",
      content: {
        type: SECTION_TYPES.TEXT,
        paragraphs: [
    ...
    {
      id: "fabrication",
      title: "6) Fabrication & installation des armoires",
      content: {
        type: SECTION_TYPES.TEXT,
        paragraphs: [
